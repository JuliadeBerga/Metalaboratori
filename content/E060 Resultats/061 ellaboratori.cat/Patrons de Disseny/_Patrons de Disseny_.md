...
Podem diferenciar tres patrons de disseny:

## [[Web ellaboratori.cat]]
>Patró dissenyat per facilitar la comunicació entre les FEP (mestres en formació) i DAM (estudiants d'informàtica de cicles).

## [[Portes (Panys)]]
>Les portes (o panys) son un patró de disseny que es troba dins [[Web ellaboratori.cat]]. 

## Patrons de Disseny de Videojocs:
Amb l'objectiu de facilitar el procés d'idear un videojoc, [[Web ellaboratori.cat]] proposa els següents exemples de patrons per a les FEP:


### [[Between Platforms GO]]
### [[Photo GO]]
### [[Insta GO]]
