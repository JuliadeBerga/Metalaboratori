...
La diferència entre cooperar i col·laborar pot observar-se en la següent informació extreta de [coop-tic.eu](http://ebook.coop-tic.eu/catala/wakka.php?wiki=CooperacioOColmlaboracioQuinesDiferencies)
...
>"Els membres del grup treballen per un objectiu comú. Però cadascú, individualment, intenta assolir en solitari el consens meta. Dues produccions tenen lloc en paral·lel: una producció col·lectiva i les produccions individuals de cada participant."
  ...
  ![[ModelCollaboratiu.png]]

 
  ## Relació Control - Autonomia
...
>"L'enfocament cooperatiu es pot considerar com un mètode d'iniciació i de preparació a una autèntica col·laboració."
  ...
  ![[ControlAutonomia.png]]



## Marc Teòric Relacionat

Collaborative digital learning in schools: teacher perceptions of purpose and effectiveness, Austin et al. - 2010:
> We have used the term ‘collaborative’ rather than ‘cooperative’ to indicate that the work is structured and goes beyond the exchange of foundational knowledge (McWhaw, Schnackenberg, & Abrami, 2003).